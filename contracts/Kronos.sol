...
contract KronosToken is ERC20Permit, VaultOwned {
    using SafeMath for uint256;

    uint256 public constant MAX_SUPPLY = 10*1e6*1e9; //10million
    constructor() ERC20("Kronos", "KRONOS", 9) {}

    function mint(address account_, uint256 amount_) external onlyVault {
        require(totalSupply().add(amount_) <=MAX_SUPPLY,"Max Supply Exceeds");
